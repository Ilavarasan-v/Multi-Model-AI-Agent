# agent/prompt.py
# Holds the system prompt and builds the multimodal message structure.
# The system prompt is what makes the output dynamic — it tells the model
# to invent the right structure rather than fill a predefined template.
